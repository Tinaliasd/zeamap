...
public interface TagvariantMapper 
{
    ...
    //大查询
    public List<TagvSelectCondition> selectTagvariant(@Param("accession") String accession, @Param("population") String population, @Param("description") String description,
