...
public class TagvariantServiceImpl implements ITagvariantService 
{
    ...
    //大查询
    @Override
    public List<TagvSelectCondition> selectTagvariant(String accession, String population, String description, String chr, Long start, Long end){
        return tagvariantMapper.selectTagvariant(accession,population,description,chr,start,end);
    }
