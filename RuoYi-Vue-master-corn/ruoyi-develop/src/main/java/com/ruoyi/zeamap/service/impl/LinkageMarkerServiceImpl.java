...
public class LinkageMarkerServiceImpl implements ILinkageMarkerService
{
    ...
    public List<String> selecttraitid(){
        return linkageMarkerMapper.selecttraitid();
    }
    //查找linkagemap
    @Override
    ...
    //大查询
    @Override
    public List<LinkageMarker> selectlinkage_marker(String accession, String version,String omics, String xot_uid, String linageMap, String lg, Double cm_min, Double cm_max)
    {
