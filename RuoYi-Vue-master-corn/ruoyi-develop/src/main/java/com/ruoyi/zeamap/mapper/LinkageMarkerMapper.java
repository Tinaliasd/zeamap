...
public interface LinkageMarkerMapper 
{
    ...
    //查找Trait Id
    public List<String> selecttraitid();
    ...
    //大查询
    public List<LinkageMarker> selectlinkage_marker(@Param("accession") String accession, @Param("version") String version, @Param("omics") String omics, @Param("xot_uid") String xot_uid, @Param("linkagemap") String linageMap, @Param("lg") String lg, @Param("cm_min") Double cm_min, @Param("cm_max") Double cm_max);
