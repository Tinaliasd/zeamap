...
public class InfoSelectCondition extends BaseEntity {
    ...
    public InfoSelectCondition(String analysis_name, String ref, String info_name, String info_simplename, String info_family, String target_gene, Double p_value) {
        this.analysis_name = analysis_name;
        this.ref = ref;
        this.info_name = info_name;
        this.info_simplename = info_simplename;
