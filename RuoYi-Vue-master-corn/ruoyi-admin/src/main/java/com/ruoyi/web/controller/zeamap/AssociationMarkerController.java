...
public class AssociationMarkerController extends BaseController {
    ...
    public AjaxResult selecttraitid() {
        List<String> list = associationMarkerService.selecttraitid();
        return AjaxResult.success(list);
    }
    ...
    public AjaxResult selectassociation_marker(@RequestBody AssociationMarkerSelectCondition associationMarkerSelectCondition) {
        startPage();
    ...
    public void download(HttpServletResponse response,AssociationMarkerSelectCondition associationMarkerSelectCondition) {
