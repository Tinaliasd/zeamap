...
public class TagvariantController extends BaseController {
    ...
    public TableDataInfo selectTagvariant(TagvSelectCondition tagvariantcondition) {
        startPage();
        List<TagvSelectCondition> list = tagvariantService.selectTagvariant(tagvariantcondition.getAccession(), tagvariantcondition.getPopulation(), tagvariantcondition.getDescription(),
